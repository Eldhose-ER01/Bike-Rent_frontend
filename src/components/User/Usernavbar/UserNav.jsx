    ...
    <div>
      <div className="shadow-md w-full fixed top-0 left-0 z-10">
        <div className="md:flex items-center justify-between bg-black py-4 md:px-10 px-7 md:h-24 h-20">
          ...
          <ul
            className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static text-sky-200 bg-black  md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
          ...
          >
            ...
            <li className="md:ml-8 text-xl semibold md:my-0 my-7">
              <Link className="font-semibold" to="/partner/login">
                Join Us
              </Link>
            </li>
            <li className="md:ml-8 text-xl semibold md:my-0 my-7">
            ...
            {isorder.isbookingpage ? (
              <li className="md:ml-8 text-xl semibold md:my-0 my-7">
                <Link className="font-semibold" to="/offer">
                  Offers
                </Link>
              </li>
            ) : null}
