        ...
        <div className="flex  items-center mt-7 flex-wrap">
          ...
          <div className="ml-3 flex-wrap">
            ...
            <div className="border border-primary p-[2px] rounded-full">
              <p className="text-lg font-light flex flex-wrap">{user.email}</p>
            </div>
          </div>
        </div>
          ...
          <div>
            {partner.map((partner, index) => {
              return (
                <div
                  key={index}
                  className="flex justify-center items-center py-5 border-b border-b-gray-300 flex-wrap"
                  onClick={() =>
                    partnersid(
                      partner._id,
                      partner.fname,
                ...
                >
                  <div className="cursor-pointer flex items-center">
                    ...
                    />
                    <div className="ml-6">
                      <h3 className="text-lg font-semibold flex-wrap">
