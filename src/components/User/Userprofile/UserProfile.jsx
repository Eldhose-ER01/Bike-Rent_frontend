...
import {imageupload,imagelicencefront,imagelicenceback}from '../../../configure/Userinterceptor'
...
export default function UserProfile() {
  ...
  const[images,setimages]=useState('https://icons-for-free.com/iconfiles/png/512/box+document+outline+share+top+upload+icon-1320195323221671611.png')

  const[image,setimage]=useState('https://icons-for-free.com/iconfiles/png/512/box+document+outline+share+top+upload+icon-1320195323221671611.png')
...
const iicencebackend = async (e) => {
  ...
  return (
    <div  >
      <UserNav />
      <div className={loader === false ? "flex justify-center mt-8 sm:mt-24 bg-transparent " : "flex justify-center mt-8 sm:mt-24 bg-transparent tracking-tight text-gray-900 dark:text-white opacity-30"}>
        <div className="bg-white border border-gray-300 sm:height-auto md:height-64 lg:height-80 xl:height-96 flex flex-col sm:flex-row justify-between mt-4 drop-shadow-xl">
          <div className="flex items-center pr-3">
            ...
            <img className="transition duration-300 ease-in-out hover:scale-150 rounded-full  mt-1  ml-0.5  h-[11em] w-[11em] " src={user.image} alt="" />

            <div className="absolute bottom-0 right-0 pl-10 " >
              <label htmlFor="fileInput">
                <TbCameraBolt type="file"  style={{ width: "2em", height: "2em" }} />
              </label>
          ...
          <button className=" ml-24 box-border p-6 w-36 h-7 mt-3 flex items-center justify-center border border-red-600 bg-green-500 font-bold text-lg custom-shadow hover:bg-sky-400"onClick={editprofile}>
                  Edit
                </button>
...
<img className="transition duration-300 ease-in-out hover:scale-125 h-[11em] w-[25em]" src={user.licenseFrontSide ? `${user.licenseFrontSide}?${user.licenseFrontSide}` : `${image}?${image}`} alt="" />
        ...
        <img className="transition duration-300 ease-in-out hover:scale-125 h-[11em] w-[25em]" src={user.licenseBackSide ? `${user.licenseBackSide}?${user.licenseBackSide}` : `${images}?${images}`} alt="" />
