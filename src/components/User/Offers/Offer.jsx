...
export default function Offer() {
 ...
 <div className="h-80 w-[30%] relative">
  ...
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold pt-2">
    <h1 className="text-xl bg-black text-green-400 "> The offer Provided by</h1>
    <h1 className="bg-black "> {coupon.couponName}</h1>
  </div>
  <button className="absolute bottom-0 bg-green-500 text-white px-4 py-2 left-1/2 transform -translate-x-1/2 mb-2" onClick={openModal}>
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                   ...
                   <h1 className="mt-3 pl-4">But Maximum Purchase  ₹:{coupon.maximumpurchase}</h1> 
                    <div className="mt-2">
                        
                      <p className=" text-black font-bold text-xl">
                      {/* ₹:{user.wallet} */}
                      <div className="flex justify-center mt-4  bg-red-700 border-2">{coupon.couponCode}</div>
