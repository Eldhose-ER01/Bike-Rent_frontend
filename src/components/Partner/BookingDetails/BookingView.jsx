  ...
  return (
    <div>
      ...
      <div className="mt-8 md:mt-8 h-auto lg:h-[35rem] flex flex-col lg:flex-row justify-center items-center">
        <div className="w-full lg:w-[50rem] mt-12 lg:mt-28 h-full lg:ml-14   mb-3 lg:mb-0 lg:mr-3 flex flex-col items-center lg:items-center pt-5 custom-shadow">
                              ...
                              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                  ...
                                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                      <p className="text-sm text-gray-500 ">
                                        <img
                                          src={
                                            Data[0].bike.user.licenseFrontSide
                                          }
                                          alt=""
                                          className=""
                                        />
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                  ...
                                  <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                      <img
                                        src={Data[0].bike.user.licenseBackSide}
                                        alt=""
                                      />
                                    </p>
                                  </div>
