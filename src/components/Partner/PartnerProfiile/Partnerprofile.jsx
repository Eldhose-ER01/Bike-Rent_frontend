        ...
        <div className="container mx-auto p-4 border border-red-300 custom-shadow md:mt-24 md:w-1/2 lg:w-1/2 xl:w-1/2 2xl:w-1/2 h-[40%]">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="py-3 relative">
              ...
              <label htmlFor="fileInput" className="absolute top-[80%]  ">
                <TbCameraBolt
                  type="file"
              ...
              <input id="fileInput" type="file" hidden onChange={profilepic} />
            </div>

            {/* Company Name */}
            <h2 className="text-2xl font-bold mb-2">
              {" "}
              {partner && `${partner.fname} ${partner.lname}`}
            </h2>
            {/* Profile Details */}
            <div className="flex flex-col items-start md:mt-3">
              ...
              <div className="mb-2">
                <span className="font-bold text-lg">SubLocation:</span>
                {partner?.sublocation}
              </div>
              <div>
                <span className="font-bold">Your Adhaar:</span>
