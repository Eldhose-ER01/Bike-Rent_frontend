...
import { Chartbooking } from "../../../configure/Partnerinterceptor";
...
export default function PartnerChart() {
  ...
  const finddata = async () => {
    try {
      ...
      if (response.data.success) setData(response.data.findbooking);
      ...
      setchartbar({
        ...
        options: {
          ...
          labels: ["booked", "running", "Completed", "Canceld"],
