...
import { Sales } from "../../../configure/Admininterceptor";
...
export default function AdminSales() {
  ...
  return (
    <div style={{ display: "flex" }} className="w-screen">
      ...
      <div className="container mt-5 pr-10 " ref={pdfRef}>
                      ...
                      sales.map((sales, index) => {
                        return (
                          <tr key={sales._id}>
                            ...
                            <td
                              key={index}
                              className="px-6 py-4 text-sm font-bold text-gray-800 text-left whitespace-nowrap"
                            >
                              {bookid[index]}
                            </td>

                            <td className="px-6 py-4 text-sm text-gray-800 text-left whitespace-nowrap">
                              {sales.partner.fname} {sales.partner.lname}
                            </td>
                            <td className="px-6 py-4 text-sm text-gray-800 text-left whitespace-nowrap">
                              {sales.user.fname} {sales.user.lname}
                            </td>
                            <td className="px-6 py-4 text-sm text-gray-800 text-left whitespace-nowrap">
                              {sales.pickUpDate}
                            </td>
